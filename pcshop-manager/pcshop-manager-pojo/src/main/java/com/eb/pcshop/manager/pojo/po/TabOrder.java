...
public class TabOrder {
    ...
    public TabOrder(String oid, String oname, Date otime, String pname, String pcount, Double privce, String oaddress, Integer uid, String oflag, String odesc, String aid, Integer cid) {
        this.oid = oid;
        this.oname = oname;
        this.otime = otime;
        this.pname = pname;
